...
import { Spinner, CreateCustomerModal, UserAddIcon, CustomerQRModal, BusinessScannerModal, CameraIcon, QRScannerModal, CreatePostModal } from '../components/common';
...
const BusinessPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (storedBusiness) {
            ...
            fetchAnalytics(parsedBusiness.id);
        } else {
    ...
    return (
        <>
            <CreateCustomerModal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)} qrDataUrl={newCustomerQr} />
                    ...
                    <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
                        <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                            ...
                            <div className="relative w-full md:w-1/2">
                                ...
                                />
                                <button onClick={() => setIsSearchScannerOpen(true)} className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-gray-500 hover:text-blue-600">
                            ...
                            <table className="w-full text-left">
                                ...
                                <tbody>
                                    {loadingMemberships ? (
                                        ...
                                        <tr key={membership.id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="p-3 text-center">
                                                 <button
                                                    ...
                                                    className="bg-gray-200 text-gray-700 font-semibold py-1 px-3 rounded-lg text-sm hover:bg-gray-300 mr-2"
                                                >
                                                    View
                                                </button>
                                                <button
                                        ...
                                        <tr>
                                            <td colSpan={3} className="text-center p-6 text-gray-500">No customers found.</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>

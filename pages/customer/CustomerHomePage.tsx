        ...
        <div className="flex flex-col bg-[#f8fcf9] min-h-screen text-[#0d1b12]" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
            ...
            <main className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex items-center gap-4 bg-[#f8fcf9] px-4 min-h-14 justify-between">
                    <p className="text-[#0d1b12] text-base font-normal leading-normal flex-1 truncate">{totalPoints.toLocaleString()}</p>
                    <div className="shrink-0">
                        <div className="text-[#0d1b12] flex size-7 items-center justify-center">
                    ...
                    <div className="space-y-1">
                        {memberships.map((membership) => (
                            <div 
                                ...
                                className="p-4 cursor-pointer active:opacity-70 transition-opacity"
                            >
                                <div className="flex items-stretch justify-between gap-4 rounded-lg">
                                    <div className="flex flex-col gap-1 flex-[2_2_0px]">
                                        <p className="text-[#4c9a66] text-sm font-normal leading-normal">{membership.points} points</p>
                                        ...
                                        <p className="text-[#4c9a66] text-sm font-normal leading-normal truncate">
                                            {membership.businesses?.bio || 'Retail'}
                                        </p>
                                    </div>
                                    <div

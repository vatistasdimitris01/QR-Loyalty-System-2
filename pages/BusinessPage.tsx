    ...
    if (loading || !business) return (
        <div className="flex justify-center items-center h-screen bg-[#ffffff]">
            <div className="text-center space-y-4">
                ...
                <p className="text-[#0d1b12] font-display font-bold tracking-tight">Accessing Royal Vault...</p>
            </div>
        </div>
    );
            ...
            <aside className={`hidden lg:flex flex-col bg-white sticky top-0 h-screen sidebar-transition overflow-hidden ${sidebarCollapsed ? 'w-0' : 'w-72'}`}>
                <div className="p-8 flex flex-col h-full w-72">
                    <div className="flex items-center justify-between mb-12">
                        ...
                        {/* Sidebar Toggle Button (Only visible inside sidebar when open) */}
                    ...
                    <nav className="flex flex-col gap-2 flex-grow">
                        ...
                        <div className="mt-8 pt-8 border-t border-[#f0f0f0] flex flex-col gap-2">
            ...
            <div className="flex-grow flex flex-col h-screen overflow-y-auto">
                <header className="h-20 bg-white border-b border-slate-100 px-12 flex items-center justify-between sticky top-0 z-20">
                    <div className="flex items-center gap-8">
                        {/* Global Toggle Button (Shows when sidebar is closed) */}
                        {sidebarCollapsed && (
                        ...
                        <h1 className="text-2xl font-bold font-display tracking-tight text-[#0d1b12]">{business.public_name} Dashboard</h1>
                    </div>
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2 px-4 py-2 bg-green-50 text-[#4c9a66] rounded-full text-xs font-black uppercase tracking-widest border border-green-100">
    ...
    return (
        <div className="space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard title="Points Awarded" value={analytics?.points_awarded_7d ?? '...'} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-white p-10 rounded-[2.5rem] border border-slate-100">
                     <h3 className="text-[11px] font-black font-display text-slate-400 uppercase tracking-[0.2em] mb-10">Historical Retention</h3>
                     <div className="h-72">
                ...
                <div className="bg-[#0d1b12] text-[#2bee6c] p-10 rounded-[2.5rem] flex flex-col justify-between">
                    <div className="space-y-2 mb-10">
                        ...
                        <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-[#2bee6c]/40">Program Rules</h3>
                    </div>
        ...
        <div className="bg-white p-12 rounded-[2.5rem] border border-slate-100 space-y-12">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div className="relative w-full md:w-1/2">
                    <input type="text" placeholder={t('searchByName')} value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full py-4 pl-6 pr-14 border border-slate-200 rounded-2xl bg-[#ffffff] focus:ring-[#2bee6c] focus:border-[#2bee6c] font-medium" />
                </div>
            </div>
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50 border-b border-slate-200">
                            <th className="px-6 py-4 text-xs font-bold text-slate-400 uppercase tracking-widest">Stakeholder</th>

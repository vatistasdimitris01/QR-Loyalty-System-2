...
const translations = {
  en: {
    ...
    landingCtaBusiness: 'Start for Free',
    ...
    manageProducts: 'Manage Shop Products',
    manageProductsDesc: 'Add items that will appear in your shop tab.',
    ...
    noBusinessProducts: 'This business hasn\'t added any products yet.',
    // Account Deletion
  ...
  el: {
    ...
    landingCtaBusiness: 'Ξεκινήστε Δωρεάν',
    ...
    manageProductsDesc: 'Προσθέστε προϊόντα στο κατάστημά σας.',
    newProduct: 'Νέο Προϊόν',
    productName: 'Όνομα Προϊόντος',
    description: 'Περιγραφή (προαιρετικό)',
    price: 'Τιμή',
    productUrl: 'Σύνδεσμος σελίδας προϊόντος',
    createProduct: 'Δημιουργία Προϊόντος',
    noProducts: 'Δεν έχετε προσθέσει προϊόντα.',
    ...
    noBusinessProducts: 'Αυτή η επιχείρηση δεν έχει προσθέσει προϊόντα.',

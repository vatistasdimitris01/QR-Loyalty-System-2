...
const CustomerPage: React.FC<CustomerPageProps> = ({ qrToken }) => {
  ...
  if (loading) return <div className="h-screen flex items-center justify-center bg-[#f8fcf9]"><Spinner className="size-10 text-primary/20" /></div>;
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col bg-[#f8fcf9] justify-between overflow-x-hidden font-sans">
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-[#f8fcf9] border-t border-[#e7f3eb] px-4 pb-8 pt-2 z-50 flex justify-between items-center shadow-lg">
            <NavItem 
